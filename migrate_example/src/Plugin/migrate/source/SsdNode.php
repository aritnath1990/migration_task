...
/**
 * @file
 * Contains \Drupal\migrate_example\Plugin\migrate\source\SsdNode.
 */
...
class SsdNode extends SqlBase {
  ...
  public function query() {
     ...
     * migrate_example_ssd_topic_node in our query, to pull in the
     ...
     * below.
     */
    $query = $this->select('migrate_example_ssd_node', 'b')
  ...
  public function prepareRow(Row $row) {
     ...
     */
    $terms = $this->select('migrate_example_ssd_topic_node', 'bt')
                 ->fields('bt', ['style'])
